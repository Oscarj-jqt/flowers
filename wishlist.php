...
<h1 class="title">products added</h1>
    ...
    <div class="box-container">
        ...
        <form action="" method="POST" class="box">
            ...
            class="fas fa-times" onclick="return confirm('delete this from wishlist ?');
            "></a>
            <a href="view_page.php?pid=<?php echo $fetch_wishlist['pid']; ?>"
            class="fas fa-eye"></a>
            <img src="/<?php echo $fetch_wishlist['image']; ?>" alt="" 
            class="image">
    ...
    <div class="wishlist-total">
        ...
        ($grand_total > 1)?'':'disabled' ?>" onclick="return confirm('delete all
        from wishlist?');">delete all </a>
