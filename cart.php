...
<h1 class="title">products added</h1>
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            class="fas fa-times" onclick="return confirm('delete this from cart ?');
            "></a>
            <a href="view_page.php?pid=<?php echo $fetch_çcart['pid']; ?>"
            class="fas fa-eye"></a>
            ...
            <form action="" method="post">
                ...
                name="cart_id">
                <input type="number" min="1" value="<?php echo $fetch_cart
                ['quantity']; ?>" name="cart_quantity" class="qty">
